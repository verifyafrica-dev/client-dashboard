...
import { AmlScreeningForm } from "./-components/aml-screening-form";
import { AmlScreeningInfoPanel } from "./-components/aml-screening-info-panel";
...
function AmlScreeningPage() {
	const product = getProduct("aml-screening");
